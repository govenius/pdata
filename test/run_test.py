...
class TestSavingAndAnalysis(unittest.TestCase):
  ...
  def test_dataexplorer_selector(self):
    ...
    self.assertTrue(os.path.split(self._single_column_datadir)[-1] in sel.options)
    self.assertTrue(os.path.split(self._no_rows_datadir)[-1] in sel.options)
    self.assertTrue(os.path.split(self._single_row_datadir)[-1] in sel.options)
    self.assertTrue(os.path.split(self._typical_datadir)[-1] in sel.options)
